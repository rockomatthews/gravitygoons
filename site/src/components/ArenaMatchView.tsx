...
type WagerDetail = { requested: boolean; enabled: boolean; configured: boolean; escrowAddress: `0x${string}` | null; escrowVersion: string | null; correctionWindowSeconds: number | null; usdcAddress: `0x${string}` | null; state: string; stakeMinor: number | null; houseFeeBps: number; fundingDeadline: string | null; notice: string; terms: WagerTerms | null; chain: { paused: boolean; state: string; fundedA: boolean; fundedB: boolean; termsHash: `0x${string}`; disputeDeadline: number; resultHash: `0x${string}` } | null };
