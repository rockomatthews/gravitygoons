...
export default async function GamePage({ searchParams }: { searchParams: Promise<{ match?: string }> }) {
  ...
  return <main className="game-lab">
    ...
    <section id="rules" className="game-rules shell">
      ...
      <article><b>04</b><h2>Spend Grit wisely</h2><p>Each player gets three Grit. Spend one while setting to SEND IT; required replications run automatically with no responder decision. Once Grit is spent, it is gone for the match.</p></article>
