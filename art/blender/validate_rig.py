...
def main():
    ...
    if rig and rig.get("sport_gear_system") != "sport-gear-detail-v4":
        errors.append(f"Missing sport gear detail system: {rig.get('sport_gear_system')}")
    ...
    report = {
        ...
        "sport_gear_system": rig.get("sport_gear_system") if rig else None,
